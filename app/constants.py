...
PAGINAS_SISTEMA = {
    ...
    'auditoria': 'Auditoria',
    'empresa': 'Empresa',
    'ecommerce_config': 'E-commerce - Configuracao',
...
PAGINAS_SISTEMA_MENU_ORDEM = (
    ('Dashboard', ('inicio',)),
    ('Gestao', ('gestao_negocio',)),
    ('Financeiro', ('financeiro',)),
    ('Vendas', ('pdv', 'pedidos', 'mesas', 'caixas', 'garcons')),
    ('Expedicao', ('expedicao',)),
    ('Estoque', ('estoques', 'produtos', 'categorias', 'fornecedores', 'enderecos_estoque', 'enderecos_inteligentes', 'equipamentos_estoque', 'movimentacoes', 'relatorios')),
    ('Meu RH', ('rh_indicadores', 'rh_organograma', 'funcionarios', 'rh_funcoes', 'auditoria', 'empresa')),
